...
def get_option_data(symbol, expiration, strike, right, days_back=30):
    ib = IB()
...
if __name__ == "__main__":
    symbol = 'VIX'
    expiration = '20240924'  # Use a nearer expiration date
    strike = 16.0  # Use a strike price closer to current market price
    right = 'C'
